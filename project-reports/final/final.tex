...
\begin{table}[h]
\caption{Different Modeling Method Accuracy Comparison}
\label{tab:m1}
\begin{tabular}{ p{3cm} | c | p{2cm}}
    \hline
    \textbf{Data Model} & \textbf{Algorithm} & \textbf{Accuracy}  \\ \hline
   \textbf{Historical Data Only} &  4 & 5\%  \\ \hline
   \textbf{Real-Time Data Only, After Set 1} &  4 & 5\%  \\ \hline
   \textbf{Historical + Current Data (after Set 1)} &  4 & 5\%  \\ \hline
   \textbf{Historical + Current Data (after Set 2)} &  4 & 5\%  \\ \hline
\end{tabular}
\end{table}
